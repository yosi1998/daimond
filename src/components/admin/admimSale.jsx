...
const AdmimSale = () => {
    ...
    const doApi = async () => {
      ...
      const url = API_URL + "/promotion?page="+page;
    ...
    const onDelClick = async(_delId)=>{
      ...
      try {
        const url = API_URL+"/promotion/"+_delId;
      ...
      <div>
        <div className="container-lg ">
          ...
          <div className="text-center pb-5">
            <PagesBtns
              linkTo={"/admin/adminpromotion?page="}
              cssClass="btn btn-dark ms-2"
              apiUrl={API_URL + "/promotion/count"}
            />
          </div>
        </div>
      </div>
